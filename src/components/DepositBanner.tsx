...
// Ultra-premium Vertical aspect-[3/4] Deposit Request Banner for Casino grid
export const VerticalDepositBanner: React.FC<{ onClick: () => void }> = ({ onClick }) => {
  return (
    <motion.div
      ...
      >
        ...
        <div className="flex justify-between items-center w-full">
          <div className="flex items-center gap-1.5 bg-black/90 backdrop-blur-md px-2.5 py-1 rounded-lg border border-amber-500/30 shadow-lg">
            ...
            <span className="text-amber-400 text-[9px] font-black tracking-widest uppercase">DEPOSIT</span>
          </div>
          
          <div className="text-amber-500/40 text-xs font-black">★ ★ ★</div>
        </div>

        {/* MIDDLE: 3D GLOWING ROTATING BANKNOTE COIN & HANDLE */}
        <div className="flex flex-col items-center justify-center my-auto gap-4">
          ...
          <div className="relative flex items-center justify-center w-28 h-28 rounded-full bg-gradient-to-b from-[#fff2a3] via-[#e5b83b] to-[#875b11] p-[3px] shadow-[0_0_35px_rgba(229,184,59,0.55)] group-hover:shadow-[0_0_50px_rgba(229,184,59,0.8)] transition-all duration-700">
            ...
            <div className="absolute inset-[3px] bg-neutral-950 rounded-full flex items-center justify-center">
              ...
              {/* Inner shiny green space for money */}
              <div className="relative w-full h-full bg-gradient-to-br from-[#10b981] via-[#059669] to-[#047857] rounded-full p-[2px] overflow-hidden shadow-[inset_0_4px_12px_rgba(255,255,255,0.4)]">
                ...
                {/* Vector Banknote icon */}
                <div className="w-full h-full flex items-center justify-center bg-transparent relative z-10 pb-0.5">
                  <Banknote className="w-12 h-12 text-white transform -rotate-12 translate-x-[2px] translate-y-[2px] filter drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)] group-hover:scale-110 transition-transform duration-350" />
                </div>
              </div>
            </div>
          </div>
