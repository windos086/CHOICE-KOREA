      ...
      >
        ...
        <div className="flex flex-col items-center justify-center my-auto gap-4">
          ...
          <div className="flex flex-col items-center gap-1.5">
            {/* Elegant 3D Title */}
            <h2 className="text-2xl font-black bg-clip-text text-transparent bg-gradient-to-b from-[#ffffff] via-[#fed7aa] to-[#f59e0b] filter drop-shadow-[0_2px_3px_rgba(0,0,0,0.95)] italic uppercase tracking-tight text-center leading-none">
              텔레그램 고객센터
            </h2>
